...
public class SchemaRegionTestUtil {
  ...
  public static ISchemaRegion createSchemaRegion(String database, int schemaRegionId)
      throws MetadataException {
    PartialPath storageGroup = new PartialPath(database);
    SchemaRegionId id = new SchemaRegionId(schemaRegionId);
    SchemaEngine.getInstance().createSchemaRegion(storageGroup, id);
    return SchemaEngine.getInstance().getSchemaRegion(id);
  }
